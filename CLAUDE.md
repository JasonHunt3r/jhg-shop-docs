...
| `transition/jhg_session_handoff_20260815_3.md` | **Current handoff — start here when resuming.** Repo state, what the third 2026-08-15 session changed (direction rule, tool header, dead-code removal), **why the finish-corridor invariant was removed rather than ported**, the open-items list, and traps |
