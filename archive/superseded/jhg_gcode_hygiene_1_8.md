...
**1.7 → 1.8 (2026-08-13):** Marked ARC-FIT PATH ROTATION as confirmed-fixed in Panel C, with a note on why the rule existed but wasn't checked first. See CHECK EXISTING RULES BEFORE DEBUGGING in the troubleshooting doc for the full lesson.
...
**See also:** [G2/G3 ARC COMMANDS](https://raw.githubusercontent.com/JasonHunt3r/jhg-shop-docs/main/jhg_gcode_hygiene_1_8.md) -- the arc fitter assumes index 0 is the start point; this rule ensures that assumption is always satisfied.
